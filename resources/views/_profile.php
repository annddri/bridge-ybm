...
// Sinkronisasi path foto untuk sidebar dan card profil
...
<head>
    ...
    <title>Profil - <?= htmlspecialchars($u['nama']) ?></title>
                    ...
                    <div class="card card-profile p-4 p-md-5">
                        ...
                        <div class="text-center">
                            <div class="position-relative d-inline-block">
                                <img src="<?= $foto_path ?>?t=<?= time() ?>" class="profile-img mb-3">
                            ...
                            <h3 class="fw-bold mt-2 text-dark"><?= htmlspecialchars($u['nama']) ?></h3>
                            <p class="text-muted small mb-4"><i class="fas fa-envelope me-1 text-primary"></i> <?= htmlspecialchars($u['email']) ?></p>
                        ...
                        <div class="row px-md-2">
                            <div class="col-md-6 border-end border-light mb-4 mb-md-0">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="info-value"><?= htmlspecialchars($u['nibs'] ?: '-') ?></div>
                                </div>
                                <div class="mb-3">
                                    <div class="info-label">NIM (Nomor Induk Mahasiswa)</div>
                                    <div class="info-value"><?= htmlspecialchars($u['nim'] ?: '-') ?></div>
                                </div>
                                <div class="mb-3">
                                    <div class="info-label">Universitas</div>
                                    <div class="info-value"><?= htmlspecialchars($u['universitas'] ?: 'Belum diisi') ?></div>
                                </div>
                                <div class="mb-3">
                                    <div class="info-label">Program Studi</div>
                                    <div class="info-value"><?= htmlspecialchars($u['prodi'] ?: 'Belum diisi') ?></div>
                                </div>
                                <div class="mb-3">
                                    <div class="info-label">Angkatan Beasiswa</div>
                                    <div class="info-value"><?= htmlspecialchars($u['angkatan'] ?: 'Belum ditentukan') ?></div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 ps-md-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="info-value"><?= htmlspecialchars($u['no_telp'] ?: 'Belum diisi') ?></div>
                                </div>
                                <div class="mb-3">
                                    <div class="info-label">Status Akun</div>
                                    <div class="info-value"><span class="badge bg-success bg-opacity-10 text-success rounded-2 px-2 fw-bold">Aktif</span></div>
                                </div>
                                <div class="mb-3">
                                    <div class="info-label">Bio Singkat</div>
                                    <p class="text-secondary small mt-1" style="line-height: 1.6;">
                                        <?= nl2br(htmlspecialchars($u['bio'] ?: 'Halo! Saya adalah bagian dari keluarga besar Bright Scholarship.')) ?>
                                    </p>
                                </div>
                            </div>
                        </div>
