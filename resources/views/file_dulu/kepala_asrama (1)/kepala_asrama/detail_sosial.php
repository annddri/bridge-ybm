...
$kategori_list = [
'kunjungan' => '📍 Kunjungan Program',
'social_project' => '🌱 Social Project',
'narasumber' => '🎤 Narasumber Pembinaan'
];
...
<?= htmlspecialchars($row['nama_kegiatan_materi']) ?>
</span>

</td>

<td>
<?= htmlspecialchars($row['lokasi_sasaran']) ?>
</td>

<td>
<?= htmlspecialchars($row['keterangan_tambahan']) ?>
</td>

<td class="text-center">

<?php if(!empty($row['link_laporan'])): ?>

<a
href="<?= htmlspecialchars($row['link_laporan']) ?>"
target="_blank"
